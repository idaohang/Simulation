...
static void initialize_c2_ekf_trial(SFc2_ekf_trialInstanceStruct *chartInstance);
static void initialize_params_c2_ekf_trial(SFc2_ekf_trialInstanceStruct
  *chartInstance);
static void enable_c2_ekf_trial(SFc2_ekf_trialInstanceStruct *chartInstance);
static void disable_c2_ekf_trial(SFc2_ekf_trialInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_ekf_trial(SFc2_ekf_trialInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c2_ekf_trial(SFc2_ekf_trialInstanceStruct
  *chartInstance);
static void set_sim_state_c2_ekf_trial(SFc2_ekf_trialInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_ekf_trial(SFc2_ekf_trialInstanceStruct *chartInstance);
static void sf_c2_ekf_trial(SFc2_ekf_trialInstanceStruct *chartInstance);
static void c2_chartstep_c2_ekf_trial(SFc2_ekf_trialInstanceStruct
  *chartInstance);
static void initSimStructsc2_ekf_trial(SFc2_ekf_trialInstanceStruct
  *chartInstance);
static void registerMessagesc2_ekf_trial(SFc2_ekf_trialInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_P_k_k, const char_T *c2_identifier, real_T c2_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[4]);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_x_k_k, const char_T *c2_identifier, real_T c2_y[2]);
static void c2_d_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, real_T c2_y[2]);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_e_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
...
static void c2_eml_scalar_eg(SFc2_ekf_trialInstanceStruct *chartInstance);
static void c2_b_eml_scalar_eg(SFc2_ekf_trialInstanceStruct *chartInstance);
static void c2_c_eml_scalar_eg(SFc2_ekf_trialInstanceStruct *chartInstance);
static real_T c2_inv(SFc2_ekf_trialInstanceStruct *chartInstance, real_T c2_x);
static void c2_eml_warning(SFc2_ekf_trialInstanceStruct *chartInstance);
static void c2_b_eml_warning(SFc2_ekf_trialInstanceStruct *chartInstance, char_T
  c2_varargin_2[14]);
static void c2_eye(SFc2_ekf_trialInstanceStruct *chartInstance, real_T c2_I[4]);
static void c2_d_eml_scalar_eg(SFc2_ekf_trialInstanceStruct *chartInstance);
static void c2_f_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_sprintf, const char_T *c2_identifier, char_T c2_y[14]);
static void c2_g_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, char_T c2_y[14]);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_h_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_i_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_ekf_trial, const char_T *c2_identifier);
static uint8_T c2_j_emlrt_marshallIn(SFc2_ekf_trialInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_ekf_trialInstanceStruct *chartInstance);
...
static void initialize_c2_ekf_trial(SFc2_ekf_trialInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_ekf_trial = 0U;
}
  ...
  *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_ekf_trial;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_ekf_trial = c2_i_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 2)), "is_active_c2_ekf_trial");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_ekf_trial(chartInstance);
...
static void sf_c2_ekf_trial(SFc2_ekf_trialInstanceStruct *chartInstance)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c2_y_hat_k, 1U);
  _SFD_DATA_RANGE_CHECK(*c2_y_k, 2U);
  for (c2_i5 = 0; c2_i5 < 2; c2_i5++) {
    _SFD_DATA_RANGE_CHECK((*c2_x_k_k)[c2_i5], 3U);
  }
  ...
  for (c2_i7 = 0; c2_i7 < 4; c2_i7++) {
    _SFD_DATA_RANGE_CHECK((*c2_P_k_k)[c2_i7], 5U);
  }

  _SFD_DATA_RANGE_CHECK(*c2_R, 6U);
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_ekf_trial(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  real_T c2_u[4];
  const mxArray *c2_y = NULL;
  SFc2_ekf_trialInstanceStruct *chartInstance;
  chartInstance = (SFc2_ekf_trialInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_ekf_trial_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c2_b_is_active_c2_ekf_trial, const char_T *c2_identifier)
{
  ...
  c2_y = c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_ekf_trial), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_ekf_trial);
  return c2_y;
}
...
void sf_c2_ekf_trial_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1342524317U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(325488513U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(418956713U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4027295615U);
}

mxArray *sf_c2_ekf_trial_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("eA3wrUA1W8m5XcHRHzRBTF");
...
mxArray *sf_c2_ekf_trial_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_ekf_trial(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[10],T\"P_k_k\",},{M[1],M[5],T\"x_k_k\",},{M[8],M[0],T\"is_active_c2_ekf_trial\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_ekf_trial_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_ekf_trialInstanceStruct *chartInstance;
    chartInstance = (SFc2_ekf_trialInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"y_hat_k");
          _SFD_SET_DATA_PROPS(2,1,1,0,"y_k");
          _SFD_SET_DATA_PROPS(3,2,0,1,"x_k_k");
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, c2_y_hat_k);
          _SFD_SET_DATA_VALUE_PTR(2U, c2_y_k);
          _SFD_SET_DATA_VALUE_PTR(3U, *c2_x_k_k);
          _SFD_SET_DATA_VALUE_PTR(4U, *c2_P_hat_k);
          _SFD_SET_DATA_VALUE_PTR(5U, *c2_P_k_k);
...
{
  return "hDFJ0GP3LdnmbIoS52ceBD";
}

static void sf_opaque_initialize_c2_ekf_trial(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_ekf_trialInstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*)
    chartInstanceVar);
  initialize_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_ekf_trial(void *chartInstanceVar)
{
  enable_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_ekf_trial(void *chartInstanceVar)
{
  disable_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_ekf_trial(void *chartInstanceVar)
{
  sf_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_ekf_trial(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_ekf_trial();/* state var info */
...
extern void sf_internal_set_sim_state_c2_ekf_trial(SimStruct* S, const mxArray
  *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_ekf_trial(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_ekf_trial(S);
}

static void sf_opaque_set_sim_state_c2_ekf_trial(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_ekf_trial(S, st);
}

static void sf_opaque_terminate_c2_ekf_trial(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_ekf_trialInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_ekf_trial_optimization_info();
    }

    finalize_c2_ekf_trial((SFc2_ekf_trialInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_ekf_trial((SFc2_ekf_trialInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_ekf_trial(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_ekf_trial(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3026092880U));
  ssSetChecksum1(S,(1239962534U));
  ssSetChecksum2(S,(1161359471U));
  ssSetChecksum3(S,(776558559U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_ekf_trial(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_ekf_trial(SimStruct *S)
{
  SFc2_ekf_trialInstanceStruct *chartInstance;
  chartInstance = (SFc2_ekf_trialInstanceStruct *)utMalloc(sizeof
    (SFc2_ekf_trialInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_ekf_trialInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_ekf_trial;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c2_ekf_trial;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_ekf_trial;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_ekf_trial;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_ekf_trial;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_ekf_trial;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_ekf_trial;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c2_ekf_trial;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_ekf_trial;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_ekf_trial;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_ekf_trial;
...
void c2_ekf_trial_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_ekf_trial(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_ekf_trial(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_ekf_trial(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_ekf_trial_method_dispatcher.\n"
