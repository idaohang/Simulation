...
static void initialize_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct
  *chartInstance);
static void initialize_params_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct
  *chartInstance);
static void enable_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct *chartInstance);
static void disable_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct *
  chartInstance);
static void set_sim_state_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct
  *chartInstance, const mxArray *c1_st);
static void finalize_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct *chartInstance);
static void sf_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct *chartInstance);
static void c1_chartstep_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct
  *chartInstance);
static void initSimStructsc1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct
  *chartInstance);
static void registerMessagesc1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_ekf_djax_1InstanceStruct *chartInstance,
  const mxArray *c1_P_dot, const char_T *c1_identifier, real_T c1_y[4]);
static void c1_b_emlrt_marshallIn(SFc1_ekf_djax_1InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[4]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_ekf_djax_1InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_eml_scalar_eg(SFc1_ekf_djax_1InstanceStruct *chartInstance);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_d_emlrt_marshallIn(SFc1_ekf_djax_1InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_e_emlrt_marshallIn(SFc1_ekf_djax_1InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_ekf_djax_1, const char_T
  *c1_identifier);
static uint8_T c1_f_emlrt_marshallIn(SFc1_ekf_djax_1InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_ekf_djax_1InstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_ekf_djax_1 = 0U;
}
  ...
  chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_ekf_djax_1;
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_ekf_djax_1 = c1_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
     "is_active_c1_ekf_djax_1");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_ekf_djax_1(chartInstance);
...
static void sf_c1_ekf_djax_1(SFc1_ekf_djax_1InstanceStruct *chartInstance)
{
  ...
  for (c1_i3 = 0; c1_i3 < 4; c1_i3++) {
    _SFD_DATA_RANGE_CHECK((*c1_P_dot)[c1_i3], 1U);
  }
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_ekf_djax_1(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[4];
  const mxArray *c1_y = NULL;
  SFc1_ekf_djax_1InstanceStruct *chartInstance;
  chartInstance = (SFc1_ekf_djax_1InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_ekf_djax_1_get_eml_resolved_functions_info(void)
{
  ...
  *c1_identifier)
{
  ...
  c1_y = c1_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_ekf_djax_1), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_ekf_djax_1);
  return c1_y;
}
...
void sf_c1_ekf_djax_1_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2510106456U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1670989108U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3324455406U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1987615697U);
}

mxArray *sf_c1_ekf_djax_1_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QWBNkaniqjkph625PcMdCC");
...
mxArray *sf_c1_ekf_djax_1_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c1_ekf_djax_1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"P_dot\",},{M[8],M[0],T\"is_active_c1_ekf_djax_1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_ekf_djax_1_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_ekf_djax_1InstanceStruct *chartInstance;
    chartInstance = (SFc1_ekf_djax_1InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,"P_dot");
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c1_P_dot);
...
{
  return "bKw0XWyX7mkcHPuH4qvwTF";
}

static void sf_opaque_initialize_c1_ekf_djax_1(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar
    )->S,0);
  initialize_params_c1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*)
    chartInstanceVar);
  initialize_c1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_ekf_djax_1(void *chartInstanceVar)
{
  enable_c1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_ekf_djax_1(void *chartInstanceVar)
{
  disable_c1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_ekf_djax_1(void *chartInstanceVar)
{
  sf_c1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_ekf_djax_1(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_ekf_djax_1
    ((SFc1_ekf_djax_1InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_ekf_djax_1();/* state var info */
...
extern void sf_internal_set_sim_state_c1_ekf_djax_1(SimStruct* S, const mxArray *
  st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_ekf_djax_1(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_ekf_djax_1(S);
}

static void sf_opaque_set_sim_state_c1_ekf_djax_1(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c1_ekf_djax_1(S, st);
}

static void sf_opaque_terminate_c1_ekf_djax_1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_ekf_djax_1_optimization_info();
    }

    finalize_c1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_ekf_djax_1((SFc1_ekf_djax_1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_ekf_djax_1(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_ekf_djax_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3403075403U));
  ssSetChecksum1(S,(4229793908U));
  ssSetChecksum2(S,(1169406203U));
  ssSetChecksum3(S,(174207195U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_ekf_djax_1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_ekf_djax_1(SimStruct *S)
{
  SFc1_ekf_djax_1InstanceStruct *chartInstance;
  chartInstance = (SFc1_ekf_djax_1InstanceStruct *)utMalloc(sizeof
    (SFc1_ekf_djax_1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_ekf_djax_1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_ekf_djax_1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_ekf_djax_1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_ekf_djax_1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_ekf_djax_1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_ekf_djax_1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_ekf_djax_1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_ekf_djax_1;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_ekf_djax_1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_ekf_djax_1;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_ekf_djax_1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_ekf_djax_1;
...
void c1_ekf_djax_1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_ekf_djax_1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_ekf_djax_1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_ekf_djax_1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_ekf_djax_1_method_dispatcher.\n"
